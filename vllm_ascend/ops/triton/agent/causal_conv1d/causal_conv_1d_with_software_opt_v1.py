...
def _causal_conv1d_update_kernel_optimized(
    ...
    conv_state_ptr, # (num_cache_lines, dim, state_len) — may not be dim-contiguous
    ...
    for work_idx in range(pid, total_work, num_programs):
        ...
        # Load weights — contiguous dim (stride=1)
        ...
        # Load history — conv_state may have non-unit dim stride
        ...
        # Update conv_state in-place — uses original strides
