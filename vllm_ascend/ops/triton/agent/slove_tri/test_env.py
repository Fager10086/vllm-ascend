...
@contextmanager
def _triton_all_blocks_parallel():
    old = os.environ.get("TRITON_ALL_BLOCKS_PARALLEL")
    ...
    try:
        ...
        if old is None:
            ...
            os.environ["TRITON_ALL_BLOCKS_PARALLEL"] = old
...
def triton_parallel_env(fn):
    def wrapper(*args, **kwargs):
        with _triton_all_blocks_parallel():
