...
class ShapeProfiler:
    ...
    def _merge_pid_files(self, output_dir: str) -> str:
        ...
        all_records = []
        pid_pattern = os.path.join(output_dir, "shape_records_pid*.jsonl")
        pid_files = sorted(glob.glob(pid_pattern))
...
if __name__ == "__main__":
    ...
    if args.model:
        ...
        os.environ["SHAPE_PROFILER_OUTPUT_DIR"] = args.output_dir
